...
Finding:     "export APIKEY_REDACTED=cafebabe:deadbeef",
Secret:      cafebabe:deadbeef
RuleID:      sidekiq-secret
Entropy:     2.609850
File:        cmd/generate/config/rules/sidekiq.go
Line:        23
Commit:      APIKEY_REDACTED
Author:      John
Email:       john@users.noreply.github.com
Date:        2022-08-03T12:31:40Z
Fingerprint: APIKEY_REDACTED:cmd/generate/config/rules/sidekiq.go:sidekiq-secret:23
```
...
[here](https://github.com/zricethezav/gitleaks/blob/APIKEY_REDACTED/git/git.go#L17-L25)).
...
[shifting left on security](https://cloud.google.com/architecture/devops/APIKEY_REDACTED).
...
[here](https://github.com/zricethezav/gitleaks/blob/APIKEY_REDACTED/git/git.go#L48-L49)). You can set the
...
```
Finding:     aws_secret="AKIA_REDACTED"
RuleID:      aws-access-token
Secret       AKIA_REDACTED
Entropy:     3.65
File:        checks_test.go
Line:        37
Commit:      APIKEY_REDACTED
...
Fingerprint: APIKEY_REDACTED:checks_test.go:aws-access-token:37
```
...
```
git log -L 37,37:checks_test.go APIKEY_REDACTED
```
...
<p align="left">
	  <a href="https://www.tines.com/?utm_source=oss&utm_medium=sponsorship&utm_campaign=gitleaks">
		  <img alt="Tines Sponsorship" src="https://user-images.githubusercontent.com/15034943/APIKEY_REDACTED.png" width=200>
	  </a>
  </p>
